...
The job is about format conversion: your customer will send you a file, and they will get back
the converted version of the file. The file data is not known up front, and the size is also not
known.
...
The job does not need to execute a real conversion (can be just a dummy/abstract service
for that), and a sleep can be enough.

Please include some tests that will simulate or even fully cover your thought process and
